...
INSERT INTO AppUser (email, name, role, metadata)
VALUES
...
INSERT INTO Purchase (supplier, appUser, status)
VALUES
    (1, 1, 'pending'),
    (2, 2, 'completed');

-- Seed data for SALE table
INSERT INTO Sale (customer, appUser, status)
VALUES
    (1, 3, 'completed'),
    (2, 4, 'pending');
...
INSERT INTO TradeRecord (product, quantity, price, purchase, sale)
VALUES
    (1, 100, 10.00, 1, 1),
    (2, 50, 20.00, 1, 2),
    (1, 200, 15.00, 2, 1),
...
INSERT INTO ProductInventory (product, quantity, warehouse)
VALUES
    (1, 100, 1),
    (2, 50, 1),
    (1, 200, 2),
